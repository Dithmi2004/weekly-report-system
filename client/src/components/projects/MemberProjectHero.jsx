import { Filter, FolderKanban, Search } from "lucide-react";

import Button from "../common/Button";

const MemberProjectHero = ({
  searchInput,
  status,
  onSearchInputChange,
  onStatusChange,
  ...
  <section className="rounded-2xl border border-indigo-100 bg-gradient-to-br from-white via-indigo-50 to-blue-50 p-5 shadow-sm">
    <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
      <div>
        ...
        <h1 className="text-3xl font-bold text-slate-950">My Projects</h1>
        <p className="mt-1 text-slate-600">
          View assigned projects, task progress, and remaining work.
        </p>
      </div>
...
export default MemberProjectHero;
